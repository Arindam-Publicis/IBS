...
public class AXIS implements Bank {
    ...
    Customer customer;
    public AXIS(InputStreamReader isr, BufferedReader buff,Customer customer) {
        this.isr = isr;
        this.buff = buff;
        miniBalance=5000f;
        this.customer=customer;
        System.out.println("Hey " + customer.getCustomerName() + ", we have opened an AXIS account for you with a balance of " + miniBalance + " inr.");
